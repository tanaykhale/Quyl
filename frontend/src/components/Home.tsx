...
export default function Home() {
  return (
    <div className="flex-1 p-6 bg-gray-100">
      <div className="w-[1154px] flex items-center justify-center gap-[65px]">
        ...
        <div className="flex items-center justify-center gap-[40px]">
          ...
          <div className="flex items-center">
            <img src={Avatar} alt="avatar" className="h-12 w-12 mr-3" />
            <span>Adeline H. Dancy</span>
          </div>
        </div>
      </div>
      <div className="h-[664px] w-[1152px] bg-white absolute top-[81px] left-[300px]">
        <Outlet></Outlet>
      </div>
    </div>
  );
